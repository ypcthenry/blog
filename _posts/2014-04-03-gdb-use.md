...
<!-- UY BEGIN -->
<div>
<div style="width:800px; height:200px; border:1px solid red; position: relative; top: 10px;">
<div id="uyan_frame"></div>
<script type="text/javascript" src="http://v2.uyan.cc/code/uyan.js"></script>
<!-- UY END -->
</div>
<div style="margin-left:0px;margin-right:0px;position:relative;top:10px;">
